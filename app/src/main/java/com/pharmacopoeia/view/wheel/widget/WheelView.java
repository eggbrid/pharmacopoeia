...
package com.pharmacopoeia.view.wheel.widget;
...
import com.pharmacopoeia.view.wheel.widget.adapters.WheelViewAdapter;
...
//	private int[] SHADOWS_COLORS = new int[] { R.color.c_666666,
//			R.color.app_green, R.color.c_666666 };
	private int[] SHADOWS_COLORS = new int[] { 0x0000000,0x0000000
	, 0x0000000 };
