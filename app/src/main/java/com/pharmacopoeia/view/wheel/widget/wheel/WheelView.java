...
import com.pharmacopoeia.util.DensityUtil;
...
public class WheelView extends View {
     ...
     */
    public static int VALUE_TEXT_COLOR = 0xff3cb583;
    /**
     * Items text color
     */
    private static final int ITEMS_TEXT_COLOR = 0xe09c999d;
    ...
    private void initResourcesIfNecessary() {
        ...
        if (valuePaint == null) {
            ...
            valuePaint.setTextSize(textsize + (2 * dm.density));
    ...
    private void drawCenterRect(Canvas canvas) {
        ...
        int offset = getItemHeight() / 2 + DensityUtil.dip2px(context, 1);
