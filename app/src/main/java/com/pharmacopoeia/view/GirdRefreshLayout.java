...
public class GirdRefreshLayout extends SwipeRefreshLayout {
    ...
    public GirdRefreshLayout(Context context) {
        this(context, null);
    }

    public GirdRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void setChildView(final GridViewWithHeaderAndFooter mListView, boolean isLoading) {
