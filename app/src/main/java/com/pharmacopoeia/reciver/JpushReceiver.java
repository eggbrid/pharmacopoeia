package com.pharmacopoeia.reciver;

/**
 * Created by xus on 2017/8/9.
 */
...
//            String extras = bundle.getString(JPushInterface.EXTRA_EXTRA);
        try {
            if (!TextUtils.isEmpty(message)) {
                ...
                intent.setAction("com.yz.app.zhongzw.modular.other.receiver.YZPushReceiver");
