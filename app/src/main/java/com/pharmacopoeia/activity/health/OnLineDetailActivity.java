...
import com.pharmacopoeia.interfaces.adapter.OnlineDetailAdapter;
...
public class OnLineDetailActivity  extends CommentActivity implements View.OnClickListener, AdapterView.OnItemClickListener {
    //这个页面需要做刷新和加载更多
    private OnlineDetailAdapter OnlineDetailAdapter;
    ...
    private OnlineDetailResponse OnlineDetailResponse;
    ...
    public void initData() {
        ...
        OnlineDetailAdapter = new OnlineDetailAdapter(this);
        list.setAdapter(OnlineDetailAdapter);
    ...
    public void setData(OnlineDetailResponse OnlineDetailResponse) {
        this.OnlineDetailResponse = OnlineDetailResponse;
        OnlineDetailAdapter.setVideoDetailModel(OnlineDetailResponse);
        OnlineDetailAdapter.notifyDataSetChanged();
        text_video_name.setText(OnlineDetailResponse.getAliveTitle());
        text_collent.setText(OnlineDetailResponse.getCollectNum());
        text_comment.setText(OnlineDetailResponse.getCommentNum());

        text_share.setText(OnlineDetailResponse.getShareNum());
        text_play.setText(OnlineDetailResponse.getPlayNum() + "次播放");
        text_user.setText(OnlineDetailResponse.getAuthorName());
        setConllection();
        if ("false".equals(OnlineDetailResponse.getConcerned())) {
        ...
        videoplayer.setUp(OnlineDetailResponse.getAliveUrl()
                , JCVideoPlayerStandard.SCREEN_LAYOUT_NORMAL, "");
        ImageLoaderUtil.getInstance().loadNomalImage(OnlineDetailResponse.getAlivePic(), videoplayer.thumbImageView);
    }


    public void setConllection() {
        if ("false".equals(OnlineDetailResponse.getCollection())) {
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        int type = OnlineDetailAdapter.getItem(position - 1).type;

        switch (type) {
            case Item.ITEM:
                Intent intent2 = new Intent();
                intent2.setClass(OnLineDetailActivity.this, ArticleActivity.class);
                startActivity(intent2);
                break;
            case Item.SHOP:
                Intent intent1 = new Intent();
                intent1.setClass(OnLineDetailActivity.this, ShopActivity.class);
        ...
        if (APP.isLogin(this)) {
            ...
            OkHttpUtil.doPost(this, url, map, new CallBack() {
                ...
                public void onSuccess(Object o) {
                    dissPross();
                    if ("false".equals(OnlineDetailResponse.getCollection())) {
                        OnlineDetailResponse.setCollection("true");
                    } else {
                        OnlineDetailResponse.setCollection("false");
                    }
                    setConllection();
                }
                ...
                public void onError(String s) {
                    T.show(OnLineDetailActivity.this, s);
                }
    ...
    public void addComent(final String commentContent) {
        ...
        if (APP.isLogin(this)) {
            Map<String, String> map = OkHttpUtil.getFromMap(this);
            map.put("aliveId", videoId);
            map.put("commentContent", commentContent);
            map.put("userId", APP.getUser(this).getUserId());
            OkHttpUtil.doPost(this, UrlUtil.ALIVECOMMENTINSERT, map, new CallBack() {
                @Override
                public void onSuccess(Object o) {
                    Commentbean commentbean = new Commentbean();
                    commentbean.setNickName(APP.getUser(OnLineDetailActivity.this).getName());
                    commentbean.setCommentContent(commentContent);
                    OnlineDetailAdapter.setConment(commentbean);
                }
    ...
    private void getData() {
        ...
        OkHttpUtil.doPost(this, UrlUtil.ALIVEDETAIL, map, new CallBack() {
            @Override
            public void onSuccess(Object o) {
                OnlineDetailResponse res = (OnlineDetailResponse) o;
                if (res != null) {
    ...
    public void addFollow() {
        if (APP.isLogin(this)) {
            ...
            OkHttpUtil.doPost(this, UrlUtil.FOLLOWPUBLISHER, map, new CallBack() {
                @Override
                public void onSuccess(Object o) {
                    T.show(OnLineDetailActivity.this, "关注成功");
                    text_shoucang.setText("已关注");
                }
